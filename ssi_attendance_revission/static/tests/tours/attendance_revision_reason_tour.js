odoo.define("ssi_attendance_revission.attendance_revision_reason_tour", function (
    require
) {
    "use strict";
    ...
    // Revision Reason menu." "Attendance" and "Attendance Revision" are
    ...
    // — only "Configuration" (level 2) and the "Attendance Revision Reason"
    // leaf get a step (patterns.md "Jumlah level menu di IK != jumlah step
    // tour").
    var openAttendanceRevisionReasonList = function () {
        return [
            ...
            {
                content: "Open the Attendance Revision Reason menu",
                trigger:
                    '.o_menu_sections [data-menu-xmlid="ssi_attendance_revission.attendance_revision_reason_menu"]',
            },
            {
                content: "Attendance Revision Reason list is displayed",
                trigger:
                    ".o_control_panel .breadcrumb-item.active:contains(Attendance Revision Reason)",
    ...
    tour.register(
        ...
        [].concat(openAttendanceRevisionReasonList(), [
    ...
    tour.register(
        ...
        [].concat(openAttendanceRevisionReasonList(), [
            // Flow 2 — Find and open the record to edit.
            {
                ...
                trigger: ".o_data_row:contains(TOUR ARR Edit) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
    ...
    tour.register(
        ...
        [].concat(openAttendanceRevisionReasonList(), [
            // Flow 2 — Select the record to delete.
            {
                ...
                trigger:
                    ".o_data_row:contains(TOUR ARR Delete) .o_list_record_selector input",
                extra_trigger: ".o_list_view",
            },
            ...
            // Post-Condition — the record no longer appears in the list.
            {
                ...
                trigger:
                    ".o_list_view:not(:has(.o_data_row:contains(TOUR ARR Delete)))",
                run: function () {
                    // Assertion only.
                },
            },
    ...
    tour.register(
        ...
        [].concat(openAttendanceRevisionReasonList(), [
            // Flow 2 — Select the record to deactivate.
            {
                content: "Select the record",
                trigger:
                    ".o_data_row:contains(TOUR ARR Deactivate) .o_list_record_selector input",
                extra_trigger: ".o_list_view",
            },
            ...
            // list view.
            {
                ...
                trigger:
                    ".o_list_view:not(:has(.o_data_row:contains(TOUR ARR Deactivate)))",
                run: function () {
                    // Assertion only.
                },
            },
    ...
    tour.register(
        ...
        [].concat(openAttendanceRevisionReasonList(), [
            ...
            // Flow 3 — Select the record to reactivate.
            {
                content: "Select the record",
                trigger:
                    ".o_data_row:contains(TOUR ARR Activate) .o_list_record_selector input",
                extra_trigger: ".o_list_view",
            },
            ...
            // default list.
            {
                ...
                trigger: ".o_list_view .o_data_row:contains(TOUR ARR Activate)",
                run: function () {
                    // Assertion only.
                },
            },
